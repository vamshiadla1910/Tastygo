        ...
        <div className="container">
          ...
          <div className="restaurant-content">
            ...
            <div className="restaurant-details">
              ...
              <p>
                Welcome to <strong>TastyGo</strong>, where every meal is prepared fresh
                with love and quality ingredients. Come and enjoy our delicious pizzas,
                burgers, fries, desserts, and much more.
              </p>
            <div className="order-details-grid">
              <div className="detail">
                <h4>📍 Address</h4>
                <p>
                  1-4-879/52, New Bakaram <br />
                  Gandhi Nagar <br />
